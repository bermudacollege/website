...
// Optional: Active class on click too
...
/*============ Selectpicker Start ============*/
 $(document).ready( function() {
	...
	if($('.partner-slider').length>0){
		var $slickElement = $('.partner-slider')
		...
		$slickElement.slick({
			...
			arrows:true,
			appendArrows: $('.slick-nav'),
			prevArrow: '<button type="button" data-role="none" class="slick-prev" aria-label="Previous" tabindex="0" role="button"><svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M23.4137 28.0925L34.158 28.0925C35.0362 28.0925 35.748 27.3806 35.748 26.5025C35.748 25.6244 35.0362 24.9125 34.158 24.9125L23.4086 24.9125L26.3173 22.002C26.938 21.381 26.9378 20.3743 26.3166 19.7535C25.6955 19.1328 24.6887 19.133 24.0679 19.7542L18.4752 25.3505C18.1707 25.6403 17.981 26.0493 17.981 26.5025C17.981 26.9827 18.1939 27.4131 18.5303 27.7048L24.0679 33.2462C24.6887 33.8673 25.6955 33.8677 26.3166 33.2469C26.9378 32.6262 26.938 31.6196 26.3173 30.9984L23.4137 28.0925Z" fill="#019CA8"/><path fill-rule="evenodd" clip-rule="evenodd" d="M48.0645 26.5019C48.0645 38.2094 38.5726 47.7 26.8653 47.7C15.1581 47.7 5.66619 38.2094 5.66619 26.5019C5.66619 14.7946 15.1581 5.30402 26.8653 5.30403C38.5726 5.30403 48.0645 14.7946 48.0645 26.5019ZM26.8653 44.52C36.8166 44.52 44.8845 36.453 44.8845 26.5019C44.8845 16.5511 36.8166 8.48403 26.8653 8.48403C16.9143 8.48403 8.84619 16.551 8.84619 26.5019C8.84619 36.4529 16.9143 44.52 26.8653 44.52Z" fill="#019CA8"/></svg></button>',
			nextArrow: '<button type="button" data-role="none" class="slick-next" aria-label="Next" tabindex="0" role="button"><svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M29.5863 24.9075H18.842C17.9638 24.9075 17.252 25.6193 17.252 26.4975C17.252 27.3756 17.9638 28.0875 18.842 28.0875H29.5914L26.6827 30.998C26.062 31.6189 26.0622 32.6257 26.6834 33.2465C27.3045 33.8672 28.3113 33.867 28.932 33.2458L34.5248 27.6495C34.8293 27.3597 35.019 26.9507 35.019 26.4975C35.019 26.0173 34.8061 25.5869 34.4697 25.2952L28.932 19.7538C28.3113 19.1327 27.3045 19.1323 26.6834 19.7531C26.0622 20.3738 26.062 21.3804 26.6827 22.0016L29.5863 24.9075Z" fill="#019CA8"/><path fill-rule="evenodd" clip-rule="evenodd" d="M4.93555 26.4981C4.93555 14.7906 14.4274 5.3 26.1347 5.3C37.8419 5.3 47.3338 14.7906 47.3338 26.4981C47.3338 38.2054 37.8419 47.696 26.1347 47.696C14.4274 47.696 4.93555 38.2054 4.93555 26.4981ZM26.1347 8.48C16.1834 8.48 8.11555 16.547 8.11555 26.4981C8.11555 36.449 16.1834 44.516 26.1347 44.516C36.0857 44.516 44.1538 36.449 44.1538 26.4981C44.1538 16.547 36.0857 8.48 26.1347 8.48Z" fill="#019CA8"/></svg></button>',
			infinite: true,
			speed: 500,
			centerMode: true,
			centerPadding: '210	px',
			//fade: true,
			cssEase: 'linear',			
			autoplay: true,
  			autoplaySpeed: 3000,
	...
	if($('.graduation-slider').length>0){
		$('.graduation-slider').slick({
			dots: false,
			arrows:true,
			appendArrows: $('.slick-nav'),
			prevArrow: '<button type="button" data-role="none" class="slick-prev" aria-label="Previous" tabindex="0" role="button"><svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M23.4137 28.0925L34.158 28.0925C35.0362 28.0925 35.748 27.3806 35.748 26.5025C35.748 25.6244 35.0362 24.9125 34.158 24.9125L23.4086 24.9125L26.3173 22.002C26.938 21.381 26.9378 20.3743 26.3166 19.7535C25.6955 19.1328 24.6887 19.133 24.0679 19.7542L18.4752 25.3505C18.1707 25.6403 17.981 26.0493 17.981 26.5025C17.981 26.9827 18.1939 27.4131 18.5303 27.7048L24.0679 33.2462C24.6887 33.8673 25.6955 33.8677 26.3166 33.2469C26.9378 32.6262 26.938 31.6196 26.3173 30.9984L23.4137 28.0925Z" fill="#fff"/><path fill-rule="evenodd" clip-rule="evenodd" d="M48.0645 26.5019C48.0645 38.2094 38.5726 47.7 26.8653 47.7C15.1581 47.7 5.66619 38.2094 5.66619 26.5019C5.66619 14.7946 15.1581 5.30402 26.8653 5.30403C38.5726 5.30403 48.0645 14.7946 48.0645 26.5019ZM26.8653 44.52C36.8166 44.52 44.8845 36.453 44.8845 26.5019C44.8845 16.5511 36.8166 8.48403 26.8653 8.48403C16.9143 8.48403 8.84619 16.551 8.84619 26.5019C8.84619 36.4529 16.9143 44.52 26.8653 44.52Z" fill="#fff"/></svg></button>',
			nextArrow: '<button type="button" data-role="none" class="slick-next" aria-label="Next" tabindex="0" role="button"><svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M29.5863 24.9075H18.842C17.9638 24.9075 17.252 25.6193 17.252 26.4975C17.252 27.3756 17.9638 28.0875 18.842 28.0875H29.5914L26.6827 30.998C26.062 31.6189 26.0622 32.6257 26.6834 33.2465C27.3045 33.8672 28.3113 33.867 28.932 33.2458L34.5248 27.6495C34.8293 27.3597 35.019 26.9507 35.019 26.4975C35.019 26.0173 34.8061 25.5869 34.4697 25.2952L28.932 19.7538C28.3113 19.1327 27.3045 19.1323 26.6834 19.7531C26.0622 20.3738 26.062 21.3804 26.6827 22.0016L29.5863 24.9075Z" fill="#fff"/><path fill-rule="evenodd" clip-rule="evenodd" d="M4.93555 26.4981C4.93555 14.7906 14.4274 5.3 26.1347 5.3C37.8419 5.3 47.3338 14.7906 47.3338 26.4981C47.3338 38.2054 37.8419 47.696 26.1347 47.696C14.4274 47.696 4.93555 38.2054 4.93555 26.4981ZM26.1347 8.48C16.1834 8.48 8.11555 16.547 8.11555 26.4981C8.11555 36.449 16.1834 44.516 26.1347 44.516C36.0857 44.516 44.1538 36.449 44.1538 26.4981C44.1538 16.547 36.0857 8.48 26.1347 8.48Z" fill="#fff"/></svg></button>',
			infinite: true,
			speed: 500,
			centerMode: false,
			centerPadding: '0	px',
	...
	if($('.history-slider').length>0){
		$('.history-slider').slick({
			...
			arrows:true,
			appendArrows: $('.slick-nav'),
			prevArrow: '<button type="button" data-role="none" class="slick-prev" aria-label="Previous" tabindex="0" role="button"><svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M23.4137 28.0925L34.158 28.0925C35.0362 28.0925 35.748 27.3806 35.748 26.5025C35.748 25.6244 35.0362 24.9125 34.158 24.9125L23.4086 24.9125L26.3173 22.0019C26.938 21.381 26.9378 20.3742 26.3166 19.7534C25.6955 19.1327 24.6887 19.1329 24.0679 19.7541L18.4752 25.3504C18.1707 25.6403 17.981 26.0492 17.981 26.5025C17.981 26.9826 18.1939 27.413 18.5303 27.7047L24.0679 33.2461C24.6887 33.8672 25.6955 33.8676 26.3166 33.2469C26.9378 32.6261 26.938 31.6195 26.3173 30.9983L23.4137 28.0925Z" fill="#019CA8"/><path fill-rule="evenodd" clip-rule="evenodd" d="M48.0645 26.5019C48.0645 38.2094 38.5726 47.7 26.8653 47.6999C15.1581 47.6999 5.66619 38.2094 5.66619 26.5019C5.66619 14.7946 15.1581 5.30398 26.8653 5.30398C38.5726 5.30398 48.0645 14.7946 48.0645 26.5019ZM26.8653 44.5199C36.8166 44.52 44.8845 36.4529 44.8845 26.5019C44.8845 16.551 36.8166 8.48398 26.8653 8.48398C16.9143 8.48398 8.84619 16.551 8.84619 26.5019C8.84619 36.4529 16.9143 44.5199 26.8653 44.5199Z" fill="#019CA8"/></svg></button>',
			nextArrow: '<button type="button" data-role="none" class="slick-next" aria-label="Next" tabindex="0" role="button"><svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M29.5863 24.9075H18.842C17.9638 24.9075 17.252 25.6194 17.252 26.4975C17.252 27.3756 17.9638 28.0875 18.842 28.0875H29.5914L26.6827 30.9981C26.062 31.619 26.0622 32.6258 26.6834 33.2466C27.3045 33.8673 28.3113 33.8671 28.932 33.2459L34.5248 27.6496C34.8293 27.3597 35.019 26.9508 35.019 26.4975C35.019 26.0174 34.8061 25.587 34.4697 25.2953L28.932 19.7539C28.3113 19.1328 27.3045 19.1324 26.6834 19.7531C26.0622 20.3739 26.062 21.3805 26.6827 22.0017L29.5863 24.9075Z" fill="#019CA8"/><path fill-rule="evenodd" clip-rule="evenodd" d="M4.93555 26.4981C4.93555 14.7906 14.4274 5.30005 26.1347 5.30005C37.8419 5.30005 47.3338 14.7906 47.3338 26.4981C47.3338 38.2054 37.8419 47.696 26.1347 47.696C14.4274 47.696 4.93555 38.2054 4.93555 26.4981ZM26.1347 8.48005C16.1834 8.48005 8.11555 16.5471 8.11555 26.4981C8.11555 36.449 16.1834 44.516 26.1347 44.516C36.0857 44.516 44.1538 36.449 44.1538 26.4981C44.1538 16.5471 36.0857 8.48005 26.1347 8.48005Z" fill="#019CA8"/></svg></button>',
			infinite: true,
			speed: 500,
			centerMode: true,
			centerPadding: '0px',
	...
	if ($(".accordion_wapper").length > 0) {
		$(".accordion_wapper").each(function () {
			const wrapper = $(this);

			wrapper.find(".accordion").click(function () {
			$(this).toggleClass("active");
			$(this).next(".panel").slideToggle(200);
			});

			// Expand All in this wrapper
			wrapper.find(".expandAll").click(function () {
			wrapper.find(".accordion").addClass("active");
			wrapper.find(".panel").slideDown(200);
			});

			// Collapse All in this wrapper
			wrapper.find(".collapseAll").click(function () {
			wrapper.find(".accordion").removeClass("active");
			wrapper.find(".panel").slideUp(200);
			});
		});
	}
});
